  ...
  <div>
    ...
    <form @submit.prevent="grava()">
      <div class="controle">
        ...
        <input name="titulo" data-vv-as="título" v-model="foto.titulo" id="titulo" autocomplete="off"
        v-validate data-vv-rules="required|min:3|max:20">
  ...
  created() {
    ...
    if(this.id){
      this.service
        ...
        // faz os dados da foto aparecerem no ALTERAR
    }
  }
}
